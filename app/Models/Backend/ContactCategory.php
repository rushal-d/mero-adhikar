 ...
 * ContactCategory
 */
class ContactCategory extends Node
{
    use SearchableTrait;
    /**
     * Table name.
    ...
    {
        return $this->belongsToMany(Contact::class, 'contacts_category_pivot', 'category_id', 'contact_id');
    }

    public function parentcontactcategory(){
