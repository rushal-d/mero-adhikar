						...
						<table class="table table-bordered">
						  <thead>
						    <tr>
						      ...
						      <th scope="col">चलानी न.</th>
						      <th scope="col">चलानी मिति </th>
						      <th scope="col">पाउनेको नाम </th>
						  ...
						  <tbody>
						    <tr>
						      ...
						      <td>इमेल</td>
						      <td>
						      	<a href="chalani-show" class="view"><i class="far fa-eye" data-toggle="tooltip" data-placement="top" title="View"></i></a>
						      	<a href="chalani-show" class="edit"><i class="far fa-edit" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
