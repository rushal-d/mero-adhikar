							...
							<div class="contact-form">
							    <div class="row"><!-- main row open-->
											...
											<!-- opening of one field -->
							    			 <label class="col-xs-2 col-md-2"> चलानी न.:</label>
											...
											<!-- opening of one field -->
							    			 <label class="col-xs-2 col-md-2"> चलानी मिति:</label>
											...
											<!-- opening of one field -->
							    			 <label class="col-xs-2 col-md-2"> पाउनेको   ठेगाना:</label>
							    			 <span class="col-xs-4 col-md-4 form-group">
							    			 	<p>काठमाडौं नेपाल </p>
							    			 </span>
							    			 <!-- close of one field -->
				...
				<div class="card custom-card create-wrapper">
					...
					<div class="card-body">
							<div class="contact-form">
							    <div class="row"><!-- main row open-->	
									<!-- opening of one field -->
									 <label class="col-xs-2 col-md-2"> पाउनेको नाम :</label>
