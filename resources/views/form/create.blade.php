					...
					<div class="card-body">
							<div class="contact-form">
							    <div class="row"><!-- main row open-->
											...
											<!-- opening of one field -->
							    			 <label class="col-xs-2 col-md-2"> पठाउनेको   ठेगाना: <span class="required-field">*</span></label>
							    			 <span class="col-xs-4 col-md-4 form-group">
				...
				<div class="card custom-card create-wrapper">
					...
					<div class="card-body">
							<div class="contact-form">
							    <div class="row"><!-- main row open-->	
									<!-- opening of one field -->
									 <label class="col-xs-3 col-md-3"> पठाउनेको नाम : <span class="required-field">*</span>	</label>
