                                    ...
                                    @foreach($permissions as $permission)
                                        <li class="nav-item">
                                            <a data-toggle="tab" class="nav-link"
                                               role="tab"
                                               href="#{{trim(str_replace('.','',$permission->name),'#')}}_menu">{{$permission->name}}
                                            </a>
                                        </li>
                                    @endforeach
                                </ul>
